...
EXPOSE 8080
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom", "-Djavax.net.ssl.trustStore=/home/app/cacerts.jks", "-Djavax.net.ssl.trustStorePassword=changeit", "-javaagent:./newrelic/newrelic.jar", "-jar","/usr/local/lib/app.jar"]